...
class Constants {
  ...
  // Salmon
  static Color salmonMain = Color.fromARGB(255, 152, 59, 143);
  static Color salmonDark = Color.fromARGB(255, 176, 127, 187);
  static Color salmonLight = Color.fromARGB(255, 190, 87, 202);
